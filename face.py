...
# 要使用 Haarcascade实现，仅需要把库修改为lbpcascade_frontalface.xml
# window安装路径比较麻烦，可能可以改动
face_cascade = cv2.CascadeClassifier('D:/opencv/build/share/OpenCV/haarcascades/haarcascade_frontalface_default.xml')
